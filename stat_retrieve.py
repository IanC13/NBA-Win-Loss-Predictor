...
def sqlconnection():
    #This function creates the connection between python and the database in mysql
...
for i in range(4,9):
    yearNum = str(i)
    stats, = pd.read_html ('https://www.basketball-reference.com/leagues/NBA_201'+yearNum+'_per_game.html', header = None)
    ...
    stats.rename(columns={'FG%':'FGp', '3P%':'3Pp', '2P%':'2Pp', 'eFG%':'eFGp', 'FT%':'FTp', 'PS/G':'PPG'} , inplace = True )
